        ...
        <div className='bg-black w-full h-full lg:bg-opacity-50'>
          ...
          <div className='flex justify-center'>
            <div className='bg-black bg-opacity-70 px-16 py-16 self-center mt-2 lg:w-2/5 lg:max-w-md rounded-md w-full'>
              ...
              {error?<p className='text-white py-2'>{error}</p>:null}
              <div className='flex flex-col gap-4'>
                {/* <Input/> */}
                <div className="relative">
                  <input type='email' onChange={(e)=> setEmail(e.target.value)}
                    className='block rounded-md px-6 py-4 w-full text-md text-white bg-neutral-700 appearance-none
           focus:outline-none focus:ring-0 peer' placeholder="Email" id='email' autoComplete='email'
                  />
                  {/* <label
            ...
            origin-[0] left-6 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-3'
                ...
                <div className='relative'>
                  <input type='password' onChange={(e)=> setPassword(e.target.value)}
                    className='block rounded-md px-6 py-4 w-full text-md text-white bg-neutral-700 appearance-none
           focus:outline-none focus:ring-0 peer' placeholder="Password" id='Password' autoComplete='current-password'
                  />
                  {/* <label
                    className='absolute text-md text-zinc-400 duration-150 transform -translate-y-3 scale-75 top-4 z-10
            origin-[0] left-6 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-3'
                ...
                <div className="relative">
                  ...
                  <p className='text-zinc-400 mt-10'>New to Netflix?
                      <Link to='/SignUp' className='ml-2 text-white'>Sign Up</Link>
                  </p>
                </div>
              </div>
            </div>
